...
export const getSingleUsers = (id) => {
    return function (dispatch) {
        axios.get(`https://celestial-blog-backend.herokuapp.com/api/allusers/${id}`)
        .then((res) => {
...
export const updateUser = (id,data4) => {
    return function(dispatch){
        axios.put(`https://celestial-blog-backend.herokuapp.com/api/allusers/${id}`,data4)
        .then((res) => {
...
export const deleteUser = (id) => {
    return function(dispatch){
        axios.delete(`https://celestial-blog-backend.herokuapp.com/api/allusers/${id}`)
        .then((res) => {
...
export const getSingleData = (id) => {
    return function (dispatch) {
        axios.get(`https://celestial-blog-backend.herokuapp.com/api/blogdata/${id}`)
        .then((res) => {
...
export const updateData = (id,data4) => {
    return function(dispatch){
        axios.put(`https://celestial-blog-backend.herokuapp.com/api/blogdata/${id}`,data4)
        .then((res) => {
...
export const postComment = (data) => {
    return function(dispatch){
        axios.post(`https://celestial-blog-backend.herokuapp.com/api/comments`,data)
        .then((res) => {
...
export const postLike = (data) => {
    return function(dispatch){
        axios.post(`https://celestial-blog-backend.herokuapp.com/api/likes`,data)
        .then((res) => {
            dispatch(postLike1())
            dispatch(showLike1())  
          })
...
export const showSingleFeed = (id) => {
    return function (dispatch) {
        axios.get(`https://celestial-blog-backend.herokuapp.com/api/dailyfeed/${id}`)
        .then((res) => {
...
export const addFeed = (data4) => {
    return function (dispatch){
        axios.post(`https://celestial-blog-backend.herokuapp.com/api/dailyfeed`,data4)
        .then((res) => {
            dispatch(addFeed1())
            dispatch(showFeed1())  
          })
...
export const updateFeed = (id,data4) => {
    return function(dispatch){
        axios.put(`https://celestial-blog-backend.herokuapp.com/api/dailyfeed/${id}`,data4)
        .then((res) => {
