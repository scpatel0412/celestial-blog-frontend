...
const BlogDetails = () => {
  ...
  useEffect(() => {
    axios.get(`https://celestial-blog-backend.herokuapp.com/api/blogdata/${hello.id}`)
         .then((res) => {
  ...
  const handleComments = (e) => {
    ...
    if(window.confirm("Adding your comment .....")){
      axios.post(`https://celestial-blog-backend.herokuapp.com/api/comments`,{email:localStorage.getItem("bloguser email"),set_id:hello.id,comment:comment1}).then((res) => {
  ...
  return (
    ...
    <Container style={{padding:"20px"}}>
      ...
      <CardMedia
        ...
        image={Data1.image && Data1.image}
        alt="green iguana"
      />
      <CardContent>
        <Typography gutterBottom variant="h5" component="div">
          {Data1.star_name&& Data1.star_name}
        </Typography>
