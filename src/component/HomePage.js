...
const HomePage = () => {
  ...
  const images = [
    { title: "Night Sky", subtitle: " Awesome night sky withs stars", img:"https://unsplash.com/photos/EkjHd-r_jF0/download?ixid=MnwxMjA3fDB8MXxzZWFyY2h8Mzl8fG5pZ2h0JTIwc2t5fGVufDB8fHx8MTY0NDg2MjYxMw&force=true" },
    {
      title: "Milky Way",
            ...
            >
              {pages.map((page) => (
                <MenuItem key={page.id} onClick={handleCloseNavMenu}>
                  <Link to={page.link} style={{textDecoration:"none",color:"black"}}><Typography textAlign="center">{page.name}</Typography></Link>
                </MenuItem>
              ))}
              <MenuItem style={{background:"black"}}>
              <IconButton onClick={onDarkMode} >{toggleButton === false ? <Brightness4Icon style={{color:"white"}}/>:<Brightness7Icon style={{color:"white"}}/> }</IconButton>
              </MenuItem>
            </Menu>
          </Box>
          <Typography
