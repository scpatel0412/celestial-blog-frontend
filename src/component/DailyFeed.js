   ...
   useEffect(() => {
    ...
    const onHandleDailyFeed = (e) => {
      ...
      if(updateToggle === true){
        if(data1.star_name ==="" && data1.description ==="" && data1.imageLink ===""){
  ...
  return (
    ...
    <Grid container>
       ...
       <Typography component="h1" variant="h3" style={{marginTop:"20px"}}>
            ...
            <Button style={{color:"white",background:"#4D1D84"}} onClick ={() => showForm()}>{showFormToggle === false ? "Show" : "Hide"} Form</Button>&nbsp;&nbsp;<Button style={{color:"white",background:"#4D1D84"}} onClick={() => showData()}>{showDataToggle === false ? "Show" : "Hide"} Daily Feed</Button>
           ...
           <TextField
            ...
            InputLabelProps={localStorage.getItem("darkmode") ==="dark" ?{ className: classes1.textField1 }:null}
                ...
                onChange={(e)=> {setData1({...data1,star_name:e.target.value})}}
                autoFocus
              ...
              <TextField
               ...
               InputLabelProps={localStorage.getItem("darkmode") ==="dark" ?{ className: classes1.textField1 }:null}
                ...
                onChange={(e)=> {setData1({...data1,description:e.target.value})}}
              />
             ...
             <TextField
              ...
              InputLabelProps={localStorage.getItem("darkmode") ==="dark" ?{ className: classes1.textField1 }:null}
                ...
                onChange={(e)=> {setData1({...data1,imageLink:e.target.value})}}
              />
              ...
              <Button
                ...
                variant="contained"
                sx={{ mt: 3, mb: 2 }}
              >{ updateToggle === true ? 'Add New Daily Feed' : 'Update Existing Feed' 
              }
              </Button> 
            </form>
            </Grid>
      ...
      { showDataToggle === true ? ( dailyfeed2 && dailyfeed2.map((i) => {
          return(
            ...
            <CardActions>
              <Button style={{background:"#0E1F4B",color:"white"}} onClick={() => onHandleDailyFeedDelete(i._id)}>Delete Post</Button>
              <Button style={{background:"#0E1F4B",color:"white"}} onClick={() => onHandleDailyFeedUpdate1(i._id)}>Update Post</Button>
